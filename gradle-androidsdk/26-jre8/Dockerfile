FROM laincloud/gradle:4.7.0-jre8
...
RUN yes | sdkmanager "extras;android;m2repository" "extras;google;m2repository" "platforms;android-26" "build-tools;26.0.2" "platform-tools" | echo yes 
